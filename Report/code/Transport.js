...
contract Transport {
    ...
    uint8 public p_info; // product infomation 
    ...
    uint32 public dt_B_tre_nhan; // delta time
    uint32 public dt_A_tre_gui;
    uint32 public dt_B_tre_gui;
    
    string public a_A_gui; // address A send product to B
    string public a_A_nhan; // address A receive product after B transfer
    
    uint32 public m_B_tre;
    uint32 public m_B_huy;
    uint32 public m_B_tre_gui;
    uint32 public m_B_khong_hang;
    uint32 public m_B_hang_hong;
    
    uint public m_A_tre_gui; 
    uint public m_A_khong_dung_hen; 
    uint public m_A_khong_dung_hang; 
    
    // flags 
    bool private provided_info_A = false;
    bool private provided_time_A = false;
    bool private provided_money_A = false;
    bool private provided_money_B = false;
    bool private sent_deposits_A = false;
    bool private sent_deposits_B = false;
    
    bool private passed_B_nhan_hang = false; 
